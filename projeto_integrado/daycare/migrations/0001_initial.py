# Generated by Django 5.2.1 on 2025-07-26 17:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agendamento', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='daycare.agendamento')),
            ],
        ),
        migrations.AddField(
            model_name='agendamento',
            name='pet',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='daycare.pet'),
        ),
        migrations.AddField(
            model_name='agendamento',
            name='servicos',
            field=models.ManyToManyField(to='daycare.servico'),
        ),
        migrations.AddField(
            model_name='pet',
            name='tutor',
