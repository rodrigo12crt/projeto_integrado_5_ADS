# Generated by Django 5.2.1 on 2025-05-12 23:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valor_total_bruto', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nivel', models.CharField(choices=[('admin', 'Administrador'), ('funcionario', 'Funcionário')], default='funcionario', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agendamento', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='klugpet.agendamento')),
            ],
        ),
        migrations.AddField(
            model_name='agendamento',
            name='pet',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='klugpet.pet'),
        ),
        migrations.AddField(
            model_name='agendamento',
            name='servicos',
            field=models.ManyToManyField(to='klugpet.servico'),
        ),
        migrations.AddField(
            model_name='pet',
            name='tutor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='klugpet.tutor'),
        ),
        migrations.AddField(
            model_name='agendamento',
            name='tutor',
